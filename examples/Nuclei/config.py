...
# dataset -----------------------
BASEDIR = '/data'
TRAIN_DATASET = 'stage1_train' #['train2014', 'valminusminival2014']
VAL_DATASET = 'stage1_train'   # only support evaluation on single dataset
TEST_DATASET = 'stage1_test'
NUM_CLASS = 1 + 1 # 81
...
ANCHOR_SIZES = (8, 16, 32, 64, 128)# (32, 64, 128, 256, 512)
...
TEST_POST_NMS_TOPK = 2000 #1000   # if you encounter OOM in inference, set this to a smaller number
FASTRCNN_NMS_THRESH = 0.5
RESULT_SCORE_THRESH = 0.05
RESULT_SCORE_THRESH_VIS = 0.3   # only visualize confident results
RESULTS_PER_IM = 400 #100
